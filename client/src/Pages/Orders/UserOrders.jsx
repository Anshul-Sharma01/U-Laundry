...
import { FaReceipt, FaTshirt, FaCalendarAlt, FaMoneyBillWave, FaCheckCircle, FaTimesCircle } from "react-icons/fa";
...
const UserOrders = () => {
    ...
    useEffect(() => {
        dispatch(getUserOrdersHistoryThunk({ userId: userData?._id }));
    }, [dispatch, userData]);
            ...
            <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200 px-4 py-6">
                ...
                {/* Heading */}
                    <h1 className="text-3xl font-bold mb-6">
                        Welcome, <span className="text-blue-500 font-bold capitalize">{userData?.name}</span>
                    </h1>
                                        ...
                                        <div className="text-sm md:text-base flex flex-col gap-2">
                                            ...
                                            <p className="flex items-center gap-2">
                                                ...
                                                className={`${
                                                    ...
                                                    ? "text-green-500"
                                                    : "text-red-500"
                                                } font-medium ${order.status === "Payment left" && "text-red-900"}`}
                                                >
                                                {order.status}
                                                </span>
                                            </p>
